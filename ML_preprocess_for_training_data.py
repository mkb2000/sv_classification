'''
extract features for ML from a Socrates output. This script use paired result only in order to ease the learning process of ML classifier.
...
#     print "length of each line:",check_max_length_of_line(newlines)
    ...
    #add related event to the end of each line
