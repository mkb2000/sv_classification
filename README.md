This project contains two approaches for Structural Variation classification based on the use of Socrates output: rule-based and machine-learning based.
